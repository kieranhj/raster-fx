...
PRINT "TEXTURE WIDTH=", TEXTURE_WIDTH, "SCREEN_WIDTH=", SCREEN_WIDTH, " mapping width=",width," scale=", (width / TEXTURE_WIDTH), " zoom=", (TEXTURE_WIDTH / width)
...
.texture_u_base
FOR n,0,NUM_ZOOMS-1,1
w = TEXTURE_WIDTH - (TEXTURE_WIDTH+2) * (n/NUM_ZOOMS)
